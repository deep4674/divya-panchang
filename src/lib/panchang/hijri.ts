/** Tabular Islamic calendar (civil, Kuwaiti algorithm) conversion from a Julian Day Number. */
...
/** Julian Day Number for a Gregorian civil date (noon-based integer JDN). */
